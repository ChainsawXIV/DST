// Global Options
csx_opts = {
	'setupCallback': function(item){mutants_masterminds_setup(item);},
...
// Master Startup
function mutants_masterminds_dataPostLoad(data){

	mm_recalculateDerivedStats();
...
function mutants_masterminds_dataChange(options) {
...
function mutants_masterminds_setup(context){
...
function mutants_masterminds_dataPreSave(){
...
function mm_recalculateDerivedStats() {
  //Common variables
  var ability = parseInt(jQuery('.dsf_ppAbilities').html());
  var power = parseInt(jQuery('.dsf_ppPowers').html());
  var advantage = parseInt(jQuery('.dsf_ppAdvantages').html());
  var skill = parseInt(jQuery('.dsf_ppSkills').html());
  var defense = parseInt(jQuery('.dsf_ppDefenses').html());
  
  //Hit Point values
  jQuery('.dsf_hpMax').html(ability+power+advantage+skill+defense);
}