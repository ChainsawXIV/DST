// Global Options
csx_opts = {
	'setupCallback': function(item){Errant_DH2_setup(item);},
...
// Master Startup
function Errant_DH2_dataPostLoad(data){
	...
	document.body.appendChild(includes);
            ...
            if (!this.isEditMode && dynamic_sheet_attrs && dynamic_sheet_attrs.hasOwnProperty("avatar_image") && dynamic_sheet_attrs["avatar_image"].indexOf("\"/images/icons/game_character_96x96.png\"") === -1) {
                $(".ds_Errant_DH2 .dst_avatar_image").html(dynamic_sheet_attrs["avatar_image"]);
            }
...
function Errant_DH2_setup(context){
...
function Errant_DH2_dataPreSave(){
