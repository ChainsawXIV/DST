// Global Options
csx_opts = {
	'setupCallback': function(item){chainsawxiv_dd4e_setup(item);},
...
// Master Startup
function chainsawxiv_dd4e_dataPostLoad(data){
...
function chainsawxiv_dd4e_setup(context){
...
function chainsawxiv_dd4e_dataPreSave(){
