// Global Options
csx_opts = {
	'setupCallback': function(item){chainsawxiv_mage_revised_wod_setup(item);},
...
// Master Startup
function chainsawxiv_mage_revised_wod_dataPostLoad(data){
...
function chainsawxiv_mage_revised_wod_setup(context){
...
function chainsawxiv_mage_revised_wod_dataPreSave(){
