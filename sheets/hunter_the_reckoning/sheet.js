// Global Options
csx_opts = {
	'setupCallback': function(item){Tendonin_nWoD_Hunter_setup(item);},
	'uiContainer': function(){return document;},
	'defaultFieldValue':'Click to edit',
	'imagePath':'https://innersecure.net/~omnichr/external/op/dst/images/hunter/',
	'preloadFiles':[
		'add.png',
		'add_hover.png',
		'balance.png',
...
// Master Startup
function Tendonin_nWoD_Hunter_dataPostLoad(data){
...
function Tendonin_nWoD_Hunter_setup(context){
...
function Tendonin_nWoD_Hunter_dataPreSave(){
